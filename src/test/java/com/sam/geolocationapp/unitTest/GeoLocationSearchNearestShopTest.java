...
public class GeoLocationSearchNearestShopTest {
	
	public static final Logger LOGGER = LogManager.getLogger(GeoLocationSearchNearestShopTest.class);
	...
	@Test
	public void findNearestShop() throws Exception {
		...
		final String findNearestShopUrl = "/map/findNearestShops/v1";
		try {
		    ...
		    LOGGER.info("In GeoLocationControllerTest:findNearestShop : geoLocationAppResponseString : " +geoLocationAppResponseString);
		    LOGGER.info("In GeoLocationControllerTest:findNearestShop : Status : " +responseEntity.getStatusCode());
		    ...
		    geoLocationAppRequest.setShopAddress("Test_Address_2");
		    geoLocationAppRequest.setShopPincode(722102);
		    httpPostEntity = new HttpEntity<GeoLocationAppRequest>(geoLocationAppRequest, headers);
		    ...
		    geoLocationAppRequest = new GeoLocationAppRequest();
		    geoLocationAppRequest.setShopName("Test_Name_3");
		    geoLocationAppRequest.setShopAddress("Test_Address_3");
		    geoLocationAppRequest.setShopPincode(723103);
		    httpPostEntity = new HttpEntity<GeoLocationAppRequest>(geoLocationAppRequest, headers);
		    ...
		    geoLocationAppRequest = new GeoLocationAppRequest();
		    geoLocationAppRequest.setShopName("Test_Name_4");
		    geoLocationAppRequest.setShopAddress("Test_Address_4");
		    geoLocationAppRequest.setShopPincode(400001);
		    httpPostEntity = new HttpEntity<GeoLocationAppRequest>(geoLocationAppRequest, headers);
		    ...
		    geoLocationAppRequest = new GeoLocationAppRequest();
		    geoLocationAppRequest.setShopName("Test_Name_5");
		    geoLocationAppRequest.setShopAddress("Test_Address_5");
		    geoLocationAppRequest.setShopPincode(734101);
		    httpPostEntity = new HttpEntity<GeoLocationAppRequest>(geoLocationAppRequest, headers);
		    ...
		    geoLocationAppRequest = new GeoLocationAppRequest();
		    geoLocationAppRequest.setShopLatitude("22.6015112");
		    geoLocationAppRequest.setShopLongitude("88.4003915");
		    httpPostEntity = new HttpEntity<GeoLocationAppRequest>(geoLocationAppRequest, headers);
		   
		    responseEntity = restTemplateClient.exchange(findNearestShopUrl, HttpMethod.POST, 
		    											 httpPostEntity, GeoLocationAppResponse.class);
		    geoLocationAppResponse = responseEntity.getBody();
		    geoLocationAppResponseString = objectMapper.writeValueAsString(geoLocationAppResponse);
		    LOGGER.info("In GeoLocationControllerTest:findNearestShop : geoLocationAppResponseString : " +geoLocationAppResponseString);
			...
			LOGGER.error("In GeoLocationControllerTest:findNearestShop : Exception Occured : Statcktrace : " ,e);
		}
	}
